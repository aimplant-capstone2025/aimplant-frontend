...
export default function UploadImage(props: {
  ...
  return (
    <div className="flex flex-col space-y-6">
      <h3 className="h3 font-bold">Upload image</h3>
      ...
      {showImage ? (
        ...
        <div className="flex flex-col space-y-4 justify-center items-center border-4 border-gray-100 rounded-xl w-full h-[400px]">
          ...
          <UploadButton
            appearance={{
              button:
                "p-4 !text-labelText-blue ut-ready:bg-labelFill-green ut-uploading:cursor-not-allowed rounded-md bg-labelFill-blue bg-none after:bg-labelFill-orange hover:shadow-md",  // Use rounded-md here
